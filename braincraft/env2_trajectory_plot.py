"""Visualize trajectories of one or more env2 players on environment_2.

Replays the same RNN loop as challenge_2.evaluate() but records the bot
position at every step and overlays it on the sampled env2 world map.
...
PLAYERS = {
    ...
    "reflex_bio": ("env2_player_reflex_bio", "reflex_bio_player"),
    "reflex_bio2": ("env2_player_reflex_bio2", "reflex_bio2_player"),
    "bio": ("env2_player_bio", "bio_player"),
}
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Plot env2 trajectories for one or more player models.")
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    save_path = args.save or f"trajectory_env2_{'_'.join(models)}.png"
    plot_models(
        player_keys=models,
        seeds=args.seeds,
