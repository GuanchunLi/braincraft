"""Parallel 500-seed validation of env2_player_bio.py.
...
def _eval_one(outer_seed: int):
    """Mirror challenge_2.evaluate() but inline so we can return per-run scores."""
...
def main():
    ...
    ap.add_argument("--out", type=str, default="validate_env2_player_bio.npz")
