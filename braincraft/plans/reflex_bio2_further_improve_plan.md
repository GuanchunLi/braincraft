...
(i) Do we need 100*k_sharp or k_sharp itself is enough? 
(ii) Is possible to merge prox_left and safe_left (same for prox_right and safe_right)?
3. CHECKED -- Explain more on reward circuit? (what's the role of armed_katch)
4. Further parameter clarification (reordering).
5. head correction -- close loop control?